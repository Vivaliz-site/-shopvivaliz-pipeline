...
Inclua explicitamente **classe de dado histórico**: dados antigos, migrados, parcialmente migrados, anteriores a invariantes atuais, registros criados por versões legadas e entidades que atravessaram mudanças de schema/regra devem ser exercitados quando materiais. Um fluxo validado apenas com registros novos não certifica histórico existente.
